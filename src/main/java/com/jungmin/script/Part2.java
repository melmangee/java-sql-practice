...
public class Part2 {
  ...
  */
  public static final String PART2_3 =
          "insert into users (" +
          "username, email, password)" +
          "values(" +
          "'seongsu', 'melmang@kakao.com', '1234');";
  ...
  */
  public static final String PART2_4 =
          "select *" +
          " from users" +
  ...
  */
  public static final String PART2_5 =
          "select * " +
          "from users " +
          "where username != 'luckykim';";
  ...
  */
  ...
  public static final String PART2_6 =
          "select title " +
          "from posts;";
  ...
  */
  public static final String PART2_10 =
          ...
          "values (1, 'insert title', 'insert content');";
  ...
  */
  public static final String PART2_16 =
          "select u.user_id, count(*) as CommentCount " +
          "from users u " +
  ...
  */
  public static final String PART2_17 =
          "select b.name, count(p.post_id) as PostCount " +
          "from boards b " +
          "join posts p " +
           "on b.board_id = p.board_id " +
          "group by b.name;";
  ...
  */
  public static final String PART2_20 =
          "select t.name, count(p.post_id) as PostCount " +
          "from tags t " +
